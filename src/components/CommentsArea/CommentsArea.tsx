...
const CommentsArea = ({commentData , longPressHandle, handleCancelEdit, handleConfirmEdit} : ICommentArea ) => {
    ...
    <View style = {[{backgroundColor: 'white'}]}>
        ...
        {commentData?.children.map((_item,index) => {
            ...
            {(commentLevel !== 0  && commentChildLength > 0)&&  <View style = {[globalStyles.cenVItem]}>
            ...
            <View style = {[{marginHorizontal: 5,
                ...
                borderRadius : 8, 
                padding : 10}]}>
            <View style = {[globalStyles.rowItem, globalStyles.cenHItem]}>
            <TextCus style = {[
            ...
            <View style={[styles.rowItem, styles.textAreaEdit, {width :' 100%'}]}>
                        <TextInputCus
                          style={[{ margin: 5 , width : '90%'}, {height:'auto', opacity : 1}]}
                          textStyle= {[{ top :0,}]}
                          autoCapitalize="none"
                          placeholder={''}
                      ...
                      <View style ={[globalStyles.rowItem,{height:30, marginTop: 10}]}>
                <View style = {[
                            {flex: 3},]}>
                </View>
                <Buttons style = {[
            ...
            :
            (<TouchCus onPress = {() => {}} onLongPress = {() => {longPressHandle?.(_item)}}>
            <View style = {[{marginHorizontal: 5,
                marginVertical: 10,
                backgroundColor: '#c2c0c0',
                borderRadius : 8, 
            ...
            <CommentsArea key = {`${commentLevel}-${index}`} 
            commentData = {_item} 
