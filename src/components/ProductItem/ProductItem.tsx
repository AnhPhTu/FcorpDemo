...
const ProductItem = ({item, children}: IProductItemProps) => {
    ...
    const itemProps = ['product', 'product_description', 'product_price','created_at']
      return (
      <View style = {[]}
      >
        <View style={[styles.row,{paddingHorizontal : 3,height : 110, width: "100%",}, globalStyles.cenHItem]}>
