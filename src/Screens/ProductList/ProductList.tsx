import { Buttons, Header, ProductItem, SafeAreaStatusBar, SafeAreaViewCus, TextCus } from 'components';
          ...
          {/* <TextCus
            ...
            <View style = {[{padding: 2}]}>
              {productData.map((_item, index) => {
                return (
                  <View key ={`Prodcut-${index}`} style ={[{backgroundColor: '#c2c0c0', marginBottom: 12}]}>
                    <ProductItem item = {_item}>
                      ...
                      {height: 40}
                          ...
                          onPress={() => {
                            NavigationService.navigate(Routes.ProductDetails, _item)
                          }}
                          >
                          <TextCus style = {[
